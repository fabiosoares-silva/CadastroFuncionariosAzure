...
using CadastroFuncionariosAzure.Context;
...
namespace CadastroFuncionariosAzure.Controllers
{
    public class FuncionarioController : ControllerBase
    {
        ...
        {
            _context = context;
            _connectionString = configuration.GetValue<string>("ConnectionsStrings:SAConnectionString");
        ...
        public IActionResult Criar(Funcionario funcionario)
        {
            ...
            var funcionarioLog = new FuncionarioLog(funcionario, TipoAcao.Inclusao,
                funcionario.Departamento, Guid.NewGuid().ToString());
        ...
        public IActionResult Atualizar(int id, Funcionario funcionario)
        {
            ...
            var funcionarioLog = new FuncionarioLog(funcionarioBanco, TipoAcao.Atualizacao,
                funcionarioBanco.Departamento, Guid.NewGuid().ToString());
